...
const ExperienceEntry: React.FC<ExperienceEntryProps> = memo(
...
const SkillsTab: React.FC<SkillsTabProps> = memo(
  ({
    profile,
    errors,
    skillInput,
    ...
    return (
      <div className="space-y-6">
        ...
        <div>
          ...
          <label
            htmlFor="resume"
            className="flex items-center justify-center w-full p-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-primary transition-colors cursor-pointer"
          >
...
const ExperienceTab: React.FC<ExperienceTabProps> = memo(
  ({
    profile,
    errors,
    handleExperienceChange,
