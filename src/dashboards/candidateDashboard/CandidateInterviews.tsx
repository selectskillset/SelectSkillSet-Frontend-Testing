        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500">
              Experience: {interviewer.experience || "N/A"}
            </p>
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-2">
                {interviewer.availability.dates.map((date) => (
                  <div
                    key={date._id}
                  ...
                  >
                    ...
                    <button
                      ...
                      className="mt-2 text-xs px-4 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition"
                    >
                      Book Slot
                    </button>
                  </div>
