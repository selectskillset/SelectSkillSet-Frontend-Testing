...
const CandidateSettingsPage: React.FC = () => {
  const [activeSection, setActiveSection] = useState<CandidateSettingsSection>(
    CandidateSettingsSection.ACCOUNT
  );
  ...
  const settingsOptions = [
    {
      ...
      label: CandidateSettingsSection.ACCOUNT,
      component: <CandidateAccountSettings />,
    },
    {
      icon: <Lock size={20} />,
      label: CandidateSettingsSection.PRIVACY,
      component: <CandidatePrivacySettings />,
    },
    {
      icon: <FileText size={20} />,
      label: CandidateSettingsSection.TERMS,
      component: <CandidateTermsAndConditions />,
    },
  ];
  ...
  const handleSectionChange = (section: CandidateSettingsSection) => {
