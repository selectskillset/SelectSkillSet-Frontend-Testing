      ...
      <div className="bg-gray-50 rounded-lg p-6 mb-8 border border-gray-200">
        ...
        <div className="space-y-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <button onClick={() => navigate("/edit-candidate-profile")} className="text-sm text-primary hover:text-primary-dark hover:underline self-start sm:self-auto">
              Update Email
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            <div className="p-6">
              ...
              <ul className="list-disc pl-5 text-gray-600 mb-6 space-y-1">
                ...
                <li>Delete your application history</li>
