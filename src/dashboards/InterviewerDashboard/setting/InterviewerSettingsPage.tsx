...
import InterviewerNotificationSettings from "./InterviewerNotificationSettings";
...
const InterviewerSettingsPage: React.FC = () => {
  ...
  const settingsOptions = [
    ...
    {
      icon: <Bell size={20} />,
      label: InterviewerSettingsSection.NOTIFICATIONS,
    },
    { icon: <Mail size={20} />, label: InterviewerSettingsSection.SUPPORT },
    {
      icon: <AlertTriangle size={20} />,
      label: InterviewerSettingsSection.REPORT,
    },
    { icon: <FileText size={20} />, label: InterviewerSettingsSection.TERMS },
  ];
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        {activeSection === InterviewerSettingsSection.NOTIFICATIONS && (
          <InterviewerNotificationSettings />
        )}
        {activeSection === InterviewerSettingsSection.SUPPORT && (
          <InterviewerContactSupport />
        )}
        {activeSection === InterviewerSettingsSection.REPORT && (
          <InterviewerReportProblem />
        )}
        {activeSection === InterviewerSettingsSection.TERMS && (
