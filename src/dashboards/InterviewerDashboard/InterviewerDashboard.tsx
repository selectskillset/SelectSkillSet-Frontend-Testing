...
const EditPersonalInfoModal = React.memo(
  ({
    ...
    selectedCountry: { isoCode: string; name: string; code: string; phoneLength: number; maxLength: number };
...
const EditSummaryModal = React.memo(
  ({
    summary,
    onClose,
    onSave,
    ...
    summary: string;
    onClose: () => void;
    onSave: (updatedSummary: string) => Promise<void>;
  }) => {
...
const SkillsDisplay = React.memo(({ skills }: { skills: string[] }) => {
...
const ExperienceCard = ({ experience }: { experience: any }) => {
  ...
  const logoUrls = getCompanyLogoUrl(experience.company);
