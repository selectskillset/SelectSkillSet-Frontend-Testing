...
const ProfileSidebar = ({ profile, navigate }) => (
  <div className="w-full md:w-1/4 h-full bg-white shadow-lg rounded-lg p-6">
...
const MainContent = ({ profile }) => (
  <div className="flex-1 space-y-10">
    ...
    <ProfileDetailsTable profile={profile} />
...
// Profile Details Table Component
      ...
      <tbody>
        {[
          ...
          <tr key={index} className="border-b border-gray-200">
            ...
            <td className="px-4 py-2 text-left text-gray-700">{item.value}</td>
          </tr>
        ))}
      </tbody>
    </table>
